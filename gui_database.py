"""Database Mode UI: capture browsing, filtering, grouping, and image preview.

Extracted verbatim from gui.py. Depends on the GUI layer (imgui) but on nothing
else in gui.py apart from `_scanner_storage`, so it stays a leaf module.
"""
import json
